...
func TestDateRange(t *testing.T) {
	line := `#EXT-X-DATERANGE:ID="splice-6FFFFFF0",START-DATE="2014-03-05T11:15:00Z",
END-DATE="2014-03-06T11:15:00Z",DURATION=59.993,CLASS="sample.class",
SCTE35-CMD=0xFC002F0000000000FF,SCTE35-IN=0xFC002F0000000000FF,
PLANNED-DURATION=59.993,SCTE35-OUT=0xFC002F0000000000FF000014056FFFFFF00,END-ON-NEXT=YES`
